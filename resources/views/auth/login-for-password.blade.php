							...
							<div class="m-login__wrapper">
								...
								<div class="m-login__signin">
									<div class="m-login__head m--align-center">
                                        <h3 class="m-login__title">Hi {{ $username }} <br /> Welcome Back!</h3>
                                        <!-- @if ($errors->has('email'))
										...
										@endif -->
										<span class="m-login__info">Enter your Password to Login</span>
                                    </div>
                                <form class="m-login__form m-form" method="POST" action="{{ route('login') }}">
                                    @csrf
										<div class="form-group m-form__group">
                                            <!-- <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus> -->
                                            <input id="email" placeholder="Email Address" type="hidden" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} m-input email" name="email" value="{{ $email }}" required autofocus >
										...
										<div class="m-login__form-action">
											<button type="submit" id="btn-submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Sign In</button>
										</div>
									</form>
								</div>
