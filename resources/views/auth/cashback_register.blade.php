						...
						<div class="m-stack__item m-stack__item--fluid">
							<div class="m-login__wrapper">
								...
								<div class="m-login__signup" style="display:block;">
									...
									<form class="m-login__form m-form" method="POST" action="{{ route('cashback_register_step2') }}" >
                                        @csrf
										...
										<div class="form-group m-form__group">
                                            <input id="email" type="hidden" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} form-control m-input register-email" placeholder="Email Address"  name="email" value="{{ $email }}" required>
										</div>
